...
- [ ] **FOUND-01**: Next.js App Router project initialized with Tailwind CSS and shadcn/ui component library
- [ ] **FOUND-02**: Full i18n setup with next-intl -- English and Bulgarian with URL-based switching (/en, /bg) and language switcher component
...
- [ ] **FOUND-06**: Cyrillic font support -- preloaded Latin + Cyrillic subsets for Bulgarian content, no flash of unstyled text
